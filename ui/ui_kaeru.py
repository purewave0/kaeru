...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"assets/kaeru.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setLocale(QLocale(QLocale.English, QLocale.UnitedKingdom))
        MainWindow.setDocumentMode(False)
        MainWindow.setTabShape(QTabWidget.TabShape.Rounded)
        self.option_show_kana_reading = QAction(MainWindow)
        self.option_show_kana_reading.setObjectName(u"option_show_kana_reading")
        self.option_show_kana_reading.setCheckable(True)
        self.option_show_kana_reading.setChecked(True)
        self.option_show_kana_reading.setMenuRole(QAction.MenuRole.TextHeuristicRole)
        self.option_show_word_type = QAction(MainWindow)
